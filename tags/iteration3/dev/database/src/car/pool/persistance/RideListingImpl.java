...
public class RideListingImpl implements RideListing {
	...
	public RideListing getAll(){
		...
		String sql = "Select * " +
		"FROM " +
		"(Select r.idRide, u.idUser, u.username,(r.availableSeats - Count(*)) as availableSeats, r.rideDate, r.rideTime, r.rideStartLocation, r.rideStopLocation, streetNumber, streetNumberEnd, geoLocation, rideComment " +
		"FROM " +
		"(SELECT r.idRide, r.idUser, r.rideDate, r.rideTime, l.street as rideStartLocation, ll.street as rideStopLocation, r.availableSeats, m.streetNumber, m.streetNumberEnd, m.geoLocation, r.rideComment "+
